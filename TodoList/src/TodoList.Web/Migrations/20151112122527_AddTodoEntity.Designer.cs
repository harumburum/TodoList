...
namespace TodoList.Web.Migrations
{
    ...
    partial class AddTodoEntity
    {
        ...
        {
            get { return "20151112122527_AddTodoEntity"; }
        }
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("TodoList.Web.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd();
            ...
            builder.Entity("TodoList.Web.Models.Todo", b =>
                {
                    b.Property<int>("Id")
                        .GenerateValueOnAdd()
                        .StoreGeneratedPattern(StoreGeneratedPattern.Identity);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("TodoList.Web.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
